...
import { codes, invalid, name, valid, validOnlyByFormat } from './czechRepublic.vat';
...
describe('Czech Republic', () => {
  ...
  it('should return "true" result for valid VATs with extra dash characters', () => {
    valid.map((vat) => addCharsToString(vat, '-')).forEach((vat) => checkValidVat(vat, [czechRepublic], codes, name));
  });
